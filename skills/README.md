...
Each child directory is an independently installable skill. The directory name is the command name used by agents.

## Current skills

- [`pair-programming-tutor`](pair-programming-tutor/): interactive 1:1 programming, computer-science, AI, or neurobiology tutoring.

## Adding a skill

1. Copy [`templates/skill`](../templates/skill/) to `skills/<lowercase-name>/`.
